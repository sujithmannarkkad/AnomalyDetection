...
def predict():
    ...
    anomaly=df.iloc[nearest_neighbor[0][0]+1].anomaly
    text=''
    if anomaly==-1:
        text='Yes'
    else:
        text='No'
    return render_template('index.html', prediction_text='Anomaly : {}, cluster:  {}, Index:  {}'.format(text, cluster,nearest_neighbor+1))
